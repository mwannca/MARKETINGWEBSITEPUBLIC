                ...
                <div>
                    ...
                    <ScrollArea className=' h-[200px] '>
                        <div className='grid grid-cols-2'>
                            {logos.map((logo, idx) => (
                                <div key={idx} className='cursor-pointer' onClick={() => {actions.setProp(selected.id, (props) => {props.src = logo})}}>
                                    <Image alt={`image ${idx}`} src={logo} height={100} width={100} />
                                </div>
                            ))}
                        </div>
                    </ScrollArea>
                    ...
                    <ScrollArea className=' h-[200px] '>
                        <div className='grid grid-cols-2'>
                            {images.map((image, idx) => (
                                <div key={idx} className='cursor-pointer' onClick={() => {actions.setProp(selected.id, (props) => {props.src = image})}}>
                                    <Image alt={`image ${idx}`} src={image} height={100} width={100} />
                                </div>
                            ))}
